...
class MedicosControllerTest < ActionController::TestCase
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post :create, medico: { cpf: @medico.cpf, crm: @medico.crm, crm_uf: @medico.crm_uf, email: @medico.email, especialidade_id: @medico.especialidade_id, nome: @medico.nome, telefone: @medico.telefone }
    end
  ...
  test "should update medico" do
    patch :update, id: @medico, medico: { cpf: @medico.cpf, crm: @medico.crm, crm_uf: @medico.crm_uf, email: @medico.email, especialidade_id: @medico.especialidade_id, nome: @medico.nome, telefone: @medico.telefone }
    assert_redirected_to medico_path(assigns(:medico))
  end
