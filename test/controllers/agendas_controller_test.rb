...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { data_emissao: @agenda.data_emissao, medico_id: @agenda.medico_id, quantidade: @agenda.quantidade, saldo: @agenda.saldo }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { data_emissao: @agenda.data_emissao, medico_id: @agenda.medico_id, quantidade: @agenda.quantidade, saldo: @agenda.saldo }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
